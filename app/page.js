...
function Home() {
  ...
  const heatMapDataCluster1 = Array(12).fill(0).map(() => generateRandomDataPoint(cluster1Center.lat, cluster1Center.lng, 0.003));
  const heatMapDataCluster2 = Array(12).fill(0).map(() => generateRandomDataPoint(cluster2Center.lat, cluster2Center.lng, 0.003));
